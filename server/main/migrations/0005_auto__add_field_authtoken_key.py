...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthToken.key'
        db.add_column('main_authtoken', 'key', self.gf('django.db.models.fields.CharField')(default='aewgjerhg324oht4i343534', max_length=400), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthToken.key'
        db.delete_column('main_authtoken', 'key')
