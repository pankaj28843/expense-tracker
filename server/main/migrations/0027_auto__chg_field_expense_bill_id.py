...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expense.bill_id'
        db.alter_column('main_expense', 'bill_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Expense.bill_id'
        db.alter_column('main_expense', 'bill_id', self.gf('django.db.models.fields.CharField')(default=12321, max_length=100))
