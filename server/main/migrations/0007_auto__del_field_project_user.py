...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_project', 'user_id')

        # Adding M2M table for field user on 'Project'
        db.create_table('main_project_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['main.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('main_project_user', ['project_id', 'user_id'])


    def backwards(self, orm):
        
        # Adding field 'Project.user'
        db.add_column('main_project', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Removing M2M table for field user on 'Project'
        db.delete_table('main_project_user')
