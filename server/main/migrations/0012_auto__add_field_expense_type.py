...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expense.type'
        db.add_column('main_expense', 'type', self.gf('django.db.models.fields.CharField')(default=2, max_length=400), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expense.type'
        db.delete_column('main_expense', 'type')
