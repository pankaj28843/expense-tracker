...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_authtoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Project'], blank=True)),
        ))
        db.send_create_signal('main', ['AuthToken'])

        # Adding field 'Expense.token'
        db.add_column('main_expense', 'token', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.AuthToken']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AuthToken'
        db.delete_table('main_authtoken')

        # Deleting field 'Expense.token'
        db.delete_column('main_expense', 'token_id')
