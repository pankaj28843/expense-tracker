...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuthToken.project'
        db.delete_column('main_authtoken', 'project_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AuthToken.project'
        db.add_column('main_authtoken', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Project'], blank=True), keep_default=False)
