...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthToken.time'
        db.add_column('main_authtoken', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 5, 12, 15, 13, 42, 147344), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthToken.time'
        db.delete_column('main_authtoken', 'time')
