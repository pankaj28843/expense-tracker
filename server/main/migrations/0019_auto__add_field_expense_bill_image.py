...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expense.bill_image'
        db.add_column('main_expense', 'bill_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expense.bill_image'
        db.delete_column('main_expense', 'bill_image')
