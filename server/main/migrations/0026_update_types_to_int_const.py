...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        oexp = orm.Expense.objects.filter(type='Official')
        pexp = orm.Expense.objects.exclude(type='Official')
        pexp.update(type=1)
        oexp.update(type=0)

    def backwards(self, orm):
        oexp = orm.Expense.objects.filter(type=0)
        pexp = orm.Expense.objects.exclude(type=0)
        pexp.update(type='Personal')
        oexp.update(type='Official')
