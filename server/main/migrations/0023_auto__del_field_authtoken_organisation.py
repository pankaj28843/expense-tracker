...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuthToken.organisation'
        db.delete_column('main_authtoken', 'organisation_id')


    def backwards(self, orm):
        
        # Adding field 'AuthToken.organisation'
        db.add_column('main_authtoken', 'organisation', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Organisation']), keep_default=False)
