...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field users on 'Organisation'
        db.create_table('main_organisation_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['main.organisation'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('main_organisation_users', ['organisation_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field users on 'Organisation'
        db.delete_table('main_organisation_users')
