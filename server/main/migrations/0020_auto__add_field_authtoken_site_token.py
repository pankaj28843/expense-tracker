...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthToken.site_token'
        db.add_column('main_authtoken', 'site_token', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthToken.site_token'
        db.delete_column('main_authtoken', 'site_token')
