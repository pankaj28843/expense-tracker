...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_project', 'budget', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.budget'
        db.delete_column('main_project', 'budget')
    ...
    models = {
        ...
        'main.project': {
            ...
            'budget': ('django.db.models.fields.IntegerField', [], {}),
