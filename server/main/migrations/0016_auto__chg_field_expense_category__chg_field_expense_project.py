...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_expense', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Project'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Expense.project'
        db.alter_column('main_expense', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Project']))
