...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expense.bill_id'
        db.add_column('main_expense', 'bill_id', self.gf('django.db.models.fields.CharField')(default=111, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expense.bill_id'
        db.delete_column('main_expense', 'bill_id')
