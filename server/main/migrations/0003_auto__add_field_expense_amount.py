...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expense.amount'
        db.add_column('main_expense', 'amount', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Expense.amount'
        db.delete_column('main_expense', 'amount')
